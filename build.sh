...
make_customize_airootfs() {
    ...
    lynx -display_charset=utf-8 -dump -nolist 'https://wiki.archlinux.org/index.php/Installation_guide_(%E7%AE%80%E4%BD%93%E4%B8%AD%E6%96%87)?action=render' >> ${work_dir}/${arch}/airootfs/root/install_zh_CN.txt
